...
void main() {
  ...
  // Define colors based on remappedPerlin ranges
    vec3 color = vec3(0.7961, 0.9961, 1.0);

  if (remappedPerlin < 0.) {
    color = vec3(0.7569, 0.9725, 1.0);  
  } else if (remappedPerlin < 0.1) {
    color = vec3(0.5686, 0.9216, 1.0);
  } else if (remappedPerlin < 0.2) {
    color = vec3(0.502, 0.9176, 1.0);  
  } else if (remappedPerlin < 0.3) {
    color = vec3(0.8941, 0.9608, 1.0);  
  } else if (remappedPerlin < 0.4){
    color = vec3(0.6549, 0.9294, 0.9647);  
  }
